...
public class LauncherIcons {
    ...
    public static Bitmap createShortcutIcon(ShortcutInfoCompat shortcutInfoCompat, Context context, boolean z) {
        ...
        Drawable shortcutIconDrawable = instance.getDeepShortcutManager().getShortcutIconDrawable(shortcutInfoCompat, instance.getInvariantDeviceProfile().fillResIconDpi);
